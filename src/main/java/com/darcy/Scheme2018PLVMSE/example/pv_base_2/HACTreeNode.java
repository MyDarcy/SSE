...
public class HACTreeNode {
	...
	public HACTreeNode(Matrix pruningVector, Matrix pruningVectorPart1, Matrix pruningVectorPart2,
	...
	public HACTreeNode(Matrix pruningVector, Matrix clusterCenterVector, int numberOfNodeInCurrentCluster,
