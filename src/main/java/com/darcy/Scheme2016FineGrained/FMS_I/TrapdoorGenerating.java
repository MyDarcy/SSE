...
public class TrapdoorGenerating {
	...
	public Trapdoor generateTrapdoor(String query) {
		...
		interestModel.put("FileInputStream", 4);
		interestModel.put("ObjectInputStream", 9);
		interestModel.put("ClassNotFoundException", 2);
		interestModel.put("IndexOutOfBoundException", 5);
		...
		int upper = 100;
		// 超递增序列是关键词的偏好因子.
		double[] hyperIncreasingSequence = MathUtils.generateHyperIncreasingSequence(keywords.length, upper);
	...
	/*System.out.println(preferenceFactors);
		System.out.println("static:" + preferenceFactors.get("static"));
		System.out.println("final:" + preferenceFactors.get("final"));
		System.out.println("ClassNotFoundException:" + preferenceFactors.get("ClassNotFoundException"));*/
